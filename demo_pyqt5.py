...
class Demo(QWidget):
    def __init__(self):
        ...
        self.test_label_end = QLabel("End")
        ...
        self.v_layout.addWidget(self.test_label_end)
    ...
    def set_label_func(self, num):
        ...
        if int(num) % 2 == 0:
            ...
            self.test_label.setText("QQ:你好，我有事找你！")
            self.v_layout.addWidget(self.test_label)
        else:
            self.setFixedHeight(100)
            self.test_label.clear()
            self.v_layout.removeWidget(self.test_label)
